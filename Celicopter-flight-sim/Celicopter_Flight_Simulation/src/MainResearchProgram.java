...
public class MainResearchProgram extends JPanel{
	...
	protected static final double[] spacialFrequencies={1,10,100};
	/**Array of corresponding pixel widths*/
	protected static int[] pixelWidths;
	/**Test subject distance from screen in inches*/
	protected static final double distanceFromScreenInInches=48;
